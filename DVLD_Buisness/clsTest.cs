...
using static DVLD_DataAccess.clsTestData;
...
namespace DVLD_Buisness
{
    public class clsTest
    {
        ...
        private bool _AddNewTest()
        {
            ...
            this.TestID = AddNewTest(this.TestAppointmentID,
        ...
        private bool _UpdateTest()
        {
            ...
            return UpdateTest(this.TestID, this.TestAppointmentID,
                this.TestResult, this.Notes, this.CreatedByUserID);
        }
            ...
            (int PersonID, int LicenseClassID, clsTestType.enTestType TestTypeID)
        {
            ...
            if (GetLastTestByPersonAndTestTypeAndLicenseClass
        ...
        {
            return GetPassedTestCount(LocalDrivingLicenseApplicationID);
        }
